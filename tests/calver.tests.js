...
describe('errors', () => {
    ...
    test.each([
        {testdate: undefined, testoptions: {}, expectederror: "No date has been provided."},
        {testdate: null, testoptions: {}, expectederror: "No date has been provided."},
        {testdate: "2022-01-01", testoptions: null, expectederror: "No options have been provided."},
        {testdate: "2022-01-01", testoptions: undefined, expectederror: "No options have been provided."},
        {testdate: "2022.01.01", testoptions: {format:""}, expectederror: 'No format string has been provided.'},
